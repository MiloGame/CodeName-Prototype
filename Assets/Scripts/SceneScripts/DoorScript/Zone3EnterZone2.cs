...
public class Zone3EnterZone2 : MonoBehaviour
{
    public DynamicLoadSector LoadSector;
    public bool DetectPlayer;
    public bool DetectSector2=false;
    ...
    void FixedUpdate()
    {
                ...
                out hitinfo, transform.rotation, 10, layerMask))
        {
            ...
            {
                LoadSector.LoadSector(DynamicLoadSector.SectorType.Zone2Prefab);
                CallTriggerDoor();
            }
            ...
            {
                DetectSector2 = true;
                EventBusManager.Instance.NonParamPublish(EventBusManager.EventType.UnlockAreaAdd);
            }
